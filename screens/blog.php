          ...
          <?php foreach ($posts as $post) { ?>
            ...
            <div class="card card-post border col-lg-3 m-1">
              ...
              <div class="col-1 d-flex justify-content-start position-absolute z-1 end-0">
                <button class="btn text-danger" type="button" data-bs-toggle="modal" data-bs-target="#modalExcluirPost<?=$post["id_post"]?>">
                  <i class="bi bi-trash-fill"></i>
                </button>
              </div>
              <?php }?>
              <!-- Modal excluir Post-->
              <div class="modal fade" id="modalExcluirPost<?=$post["id_post"]?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-body">
                  ...
                  <form action="../src/logicos/deletePostBlog.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
