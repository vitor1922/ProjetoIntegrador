...
<body>
    ...
    <main>
        <div class="container mt-3">
            <h1 class="text-center">Área do Instrutor</h1>
            ...
            <div class="mt-4">
                <strong>Ordenar por:</st>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                        <li><a class="dropdown-item" href="/?filtro=por-turma">Mais Novo</a></li>
                        <li><a class="dropdown-item" href="/?filtro=por-servico">Mais Antigo</a></li>
                        <li><a class="dropdown-item" href="/?filtro=por-servico">Por Turma</a></li>
                    </ul>
            </div>
